  ...
  return (
    ...
    >
      <div className="grid gap-6 sm:gap-8 lg:grid-cols-[1fr_0.95fr] lg:items-center lg:gap-10">
        <FadeInUp className="relative overflow-hidden rounded-3xl bg-[linear-gradient(145deg,#f8fbff_0%,#f4f8ff_42%,#fff3f8_100%)] p-5 shadow-sm sm:p-8 dark:bg-[linear-gradient(145deg,#162138_0%,#1a2742_42%,#2a1f3c_100%)]">
          ...
          {content.highlights.map((item, index) => {
            ...
            return (
              <StaggerItem key={item.id}>
                <article className="group rounded-2xl bg-white/95 p-4 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-100/70 sm:p-5 dark:bg-slate-900/85 dark:shadow-none dark:hover:shadow-[0_16px_30px_-22px_rgba(59,130,246,0.5)]">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-[linear-gradient(150deg,#eef5ff_0%,#f2f8ff_36%,#fff2f9_100%)] p-4 shadow-xl shadow-blue-100/60 sm:p-8 lg:p-10 dark:bg-[linear-gradient(150deg,#141f36_0%,#1a2640_36%,#2a1d37_100%)] dark:shadow-none">
          ...
          <div className="relative grid gap-6 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-600 dark:bg-slate-900/70 dark:text-slate-300">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-white/90 shadow-lg shadow-blue-100/40 dark:bg-slate-900/85 dark:shadow-none">
              <div className="absolute left-4 top-4 z-10 inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-600 shadow-sm dark:bg-slate-900/80 dark:text-slate-300">
                Profil Duta
              </div>
